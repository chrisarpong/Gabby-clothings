    ...
    >
      ...
      <a
        ...
        style={{ 
          ...
          color: '#ffffff' /* TODO: Revert color to #3a1f1d when the final light background image is added */
        }}
      >
        Gabby Newluk
      </a>
      ...
      <div className="hidden md:flex flex-row gap-[2rem] items-center">
        ...
        <a
          href="#account"
          className="text-sm flex items-center gap-2 transition-colors duration-300 hover:opacity-70"
          style={{ 
            fontFamily: "'Jost', sans-serif",
            color: '#ffffff' /* TODO: Revert color to #3a1f1d when the final light background image is added */
          }}
