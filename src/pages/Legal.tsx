      ...
      <section className="px-5 md:px-20 max-w-[1536px] mx-auto flex flex-col">
        ...
        <div className="flex flex-col gap-12 max-w-3xl font-sans text-on-surface-variant">
          ...
          <div>
            ...
            <p className="leading-relaxed mb-4">
              <strong>Cancellations:</strong> Due to the bespoke nature of our garments, once an order goes into production (typically 24 hours after confirmation and payment), it cannot be cancelled. 
            </p>
            <p className="leading-relaxed mb-4">
