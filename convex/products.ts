...
export const seed = mutation({
  ...
  handler: async (ctx) => {
    ...
    const demoProducts = [
      ...
      { name: "custom-fit Navy Two-Piece", basePrice: 18200, category: "Suiting", images: ["/assets/5.jpg"], description: "Custom-fitted navy suit tailored to exact measurements.", type: "physical", status: "active" },
      ...
      { name: "Textured Silk Pocket Square", basePrice: 800, category: "Accessories", images: ["/assets/kaftan.jpeg"], description: "Hand-rolled silk pocket square to complement any custom-fit suit.", type: "physical", status: "active" },
